...
export default function Pagination({
  ...
  const buttonClass = "px-3 py-2 rounded-lg transition text-sm font-medium bg-white hover:bg-gray-100 text-gray-700 dark:text-gray-700 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  return (
    <div className="flex justify-center items-center mt-10 mb-10 space-x-1">
      ...
      {pages.map((page, index) => {
        if (page === '...') {
          return <span key={index} className="px-2 py-2 text-gray-500 dark:text-gray-700">...</span>;
        }
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition text-sm font-medium ${
              page === currentPage
                ...
                : 'bg-white hover:bg-gray-100 text-gray-700 dark:text-gray-700 shadow-sm'
            }`}
          >
            {page}
          </button>
